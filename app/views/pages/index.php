...
<body>
    <div class="h-screen md:flex">
        <div class="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-red-800 to-purple-700 i justify-around items-center hidden">
            <div>
        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white" id="signform">
            <form class="bg-white" method="post" action="<?php echo URLROOT;?>users/register">
                ...
                <input type="submit" class="block w-full bg-red-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2 cursor-pointer" value="Sign Up" name="signup">
            </form>
        </div>
    </div>
</body>
